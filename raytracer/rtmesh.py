...
from raytracer.rtcamera import Camera
from raytracer.rtpresets import Material
from raytracer.rtuvalign import get_transformed_uvs, UVAlignmentInteractor
...
class RTMesh:
    ...
    def get_mesh_data_over_time(self) -> None:
        """
...
def extract_submesh(rtmesh: RTMesh,
                    chart_face_indices: np.ndarray) -> RTMesh:
    """
...
def create_rtmesh(rtmesh: RTMesh) -> RTMesh:
    """
